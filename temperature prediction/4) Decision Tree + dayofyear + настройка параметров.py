...
# X_train['another feature'] = data_train['another feature']  # Можно добавить еще колонок в таблицу с признаками
X_test = pd.DataFrame()
X_test['dayofyear'] = data_test['dayofyear']
# X_train['another feature'] = data_train['another feature']

# "y" оставляем столбцом, как есть
y_train = data_train['T']
y_test = data_test['T']

model = DecisionTreeRegressor(max_depth=5)  # Настраиваем параметр
